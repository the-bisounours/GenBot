const { SlashCommandBuilder, EmbedBuilder, Client, ChatInputCommandInteraction, AutocompleteInteraction, PermissionsBitField, SlashCommandSubcommandBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, OAuth2Scopes } = require("discord.js");
